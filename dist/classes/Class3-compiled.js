...
var aggregation = function aggregation(baseClass) {
	...
	var base = (function (_baseClass) {
		...
		function _Combined() {
			...
			var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_Combined)).call.apply(_Object$getPrototypeO, [this].concat(_toConsumableArray(args))));
...
//# sourceMappingURL=Class3-compiled.js.map